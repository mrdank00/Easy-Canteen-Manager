...
Public Class rptMealsperDept
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Easy_Canteen_Manager.rptMealsperDept.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptMealsperDept
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMealsperDept = New rptMealsperDept()
        rpt.Site = Me.Site
        Return rpt
    End Function
