...
Public Class rptMealsPerDate
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Easy_Canteen_Manager.rptMealsPerDate.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptMealsPerDate
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMealsPerDate = New rptMealsPerDate()
        rpt.Site = Me.Site
        Return rpt
    End Function
