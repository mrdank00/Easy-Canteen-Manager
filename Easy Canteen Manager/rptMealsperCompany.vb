...
Public Class rptMealsperCompany
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Easy_Canteen_Manager.rptMealsperCompany.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptMealsperCompany
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMealsperCompany = New rptMealsperCompany()
        rpt.Site = Me.Site
        Return rpt
    End Function
