...
Public Class rptMealTyperoll
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Easy_Canteen_Manager.rptMealTyperoll.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptMealTyperoll
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMealTyperoll = New rptMealTyperoll()
        rpt.Site = Me.Site
        Return rpt
    End Function
