...
Public Class rptMealperDateSumm
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Easy_Canteen_Manager.rptMealperDateSumm.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptMealperDateSumm
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMealperDateSumm = New rptMealperDateSumm()
        rpt.Site = Me.Site
        Return rpt
    End Function
