...
Public Class rptMealPerLocSumm
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Easy_Canteen_Manager.rptMealPerLocSumm.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptMealPerLocSumm
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMealPerLocSumm = New rptMealPerLocSumm()
        rpt.Site = Me.Site
        Return rpt
    End Function
