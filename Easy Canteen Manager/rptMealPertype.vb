...
Public Class rptMealPertype
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Easy_Canteen_Manager.rptMealPertype.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptMealPertype
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMealPertype = New rptMealPertype()
        rpt.Site = Me.Site
        Return rpt
    End Function
