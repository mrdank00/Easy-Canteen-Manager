...
Public Class rptMealPerStaffSumm
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptMealPerStaffSumm.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Easy_Canteen_Manager.rptMealPerStaffSumm.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptMealPerStaffSumm
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMealPerStaffSumm = New rptMealPerStaffSumm()
        rpt.Site = Me.Site
        Return rpt
    End Function
